...
class TestUserService:
    ...
    def test_duplicate_email(self, user_service):
        ...
        duplicate = user_service.create_user(
            email="test@example.com",
            username="different",
    ...
    def test_change_password(self, user_service):
        ...
        # Change password
        result = user_service.change_password(user.id, "password123", "newpassword123")
    ...
    def test_verify_password(self, user_service):
        ...
        assert user_service.verify_password(user.id, "password123") is True
...
class TestAuthenticationService:
    ...
    def test_authenticate_user_with_username(self, auth_service, user_service):
        ...
        authenticated = auth_service.authenticate_user("authuser", "password123")
    ...
    def test_authenticate_user_with_email(self, auth_service, user_service):
        ...
        authenticated = auth_service.authenticate_user("auth2@example.com", "password123")
