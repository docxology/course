...
from curriculum.core.metadata import Metadata, DublinCore, LRMIMetadata, ResourceType, InteractivityType, EducationalUse
...
class TestBaseEntity:
    ...
    def test_base_entity_creation(self):
        ...
        assert isinstance(entity.id, UUID)  # UUID as UUID object
...
class TestContentModel:
    ...
    def test_content_versioning(self, sample_user):
        ...
        version = ContentVersion.create_from_content(content, "Initial version")
...
class TestMetadataModel:
    ...
    def test_lrmi_metadata_creation(self):
        ...
        lrmi = LRMIMetadata(
            ...
            educational_use=["lecture", "assessment"],
            learning_resource_type=["lesson", "assessment"],
        ...
        assert EducationalUse.LECTURE in lrmi.educational_use
...
class TestAssessmentModel:
    ...
    def test_assessment_creation(self, sample_user):
        ...
        assert assessment.attempts_allowed == 3
    ...
    def test_submission_creation(self, sample_user):
        ...
        assert submission.time_spent == 25
        assert submission.grading_status == GradingStatus.PENDING
    ...
    def test_submission_grading(self, sample_user):
        ...
        assert submission.grading_status == GradingStatus.COMPLETED
    ...
    def test_submission_result(self, sample_user):
        ...
        result = SubmissionResult(
            ...
            question_id=uuid4(),  # Sample question ID
